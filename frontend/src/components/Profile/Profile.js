...
function Profile() {
  ...
  useEffect(()  => {  
    ...
    axios.get(`http://localhost:5000/edit-profil?username=${ usernameC }`)
...
const handleSave = () => {
  ...
  axios.put(`http://localhost:5000/update-profil`, { 'username': usernameC,  'email': email, 'nomcomplet': namecomplet, 'usernamenew':usernameb })
